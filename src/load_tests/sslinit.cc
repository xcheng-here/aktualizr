...
void openssl_callbacks_setup(void) {
  ...
  lock_cs = (pthread_mutex_t *)OPENSSL_malloc(static_cast<int>(static_cast<unsigned int>(CRYPTO_num_locks()) * sizeof(pthread_mutex_t)));
  lock_count = (long *)OPENSSL_malloc(static_cast<int>(static_cast<unsigned int>(CRYPTO_num_locks()) * sizeof(long)));
